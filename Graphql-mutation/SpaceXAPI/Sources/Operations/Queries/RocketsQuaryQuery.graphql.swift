...
public class RocketsQuaryQuery: GraphQLQuery {
  public static let operationName: String = "RocketsQuary"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query RocketsQuary { rockets { __typename id name height { __typename meters } mass { __typename kg } } }"#
    ))
